...
export const images = {
  ...
  "hero.produce": stock(heroProduce, heroProduceSm, 1280, 855,
    "Fresh tomatoes, asparagus, lettuce and basil on a marble surface"),
  "services.private": stock(consult, consultSm, 1280, 1574,
    "A dietitian filling in a weekly meal plan with a client"),
  ...
  "services.talks": stock(talks, talksSm, 1195, 1792,
    "A colourful vegetable and quinoa bowl beside a chopping board"),
  "conditions.food": stock(conditions, conditionsSm, 1280, 854,
    "Two balanced grain bowls with roast vegetables, beans and avocado"),
